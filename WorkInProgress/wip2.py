        ...
        with st.container():
            ...
            if st.sidebar.button('Ajouter'):
                ...
                if is_ip_unique:
                    ...
                    st.sidebar.error("L'adresse IP est déjà associée à un autre pseudo.")
                else:
            ...
            if not isinstance(pseudos, list):  # Vérifie si la variable est une liste
                st.sidebar.error("Une erreur est survenue lors de la récupération des pseudos.")
                return  
            ...
            for pseudo_data in pseudos:
                ...
                st.sidebar.write(f"{pseudo} | {ip_address}")
